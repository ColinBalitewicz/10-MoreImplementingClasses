    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        self.h_rect=rg.Rectangle(rg.Point(self.intersection_center.x-width/2,self.intersection_center.y-self.letter_thickness/2),rg.Point(self.intersection_center.x+width/2,self.intersection_center.y+self.letter_thickness/2))
        self.v_rect=rg.Rectangle(rg.Point(self.intersection_center.x-self.letter_thickness/2,self.intersection_center.y-self.letter_thickness/2),rg.Point(self.intersection_center.x+self.letter_thickness/2,self.intersection_center.y+(self.height-self.letter_thickness/2)))
